...
function add_BJ_green84_jz1_layer1() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            map1.addLayer(vector_bj_greenrate1_layer);
            map2.addLayer(vector_bj_greenrate1_layer);
        },
        error: function () {
            alert('error');
        }
...
function add_BJ_green84_jz1_layer2() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            map1.addLayer(vector_bj_greenrate2_layer);
            map2.addLayer(vector_bj_greenrate2_layer);
        },
        error: function () {
            alert('error');
        }
...
function add_BJ_green84_jz1_layer3() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            map1.addLayer(vector_bj_greenrate3_layer);
            map2.addLayer(vector_bj_greenrate3_layer);
        },
        error: function () {
            alert('error');
        }
...
function add_BJ_green84_jz1_layer4() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            map1.addLayer(vector_bj_greenrate4_layer);
            map2.addLayer(vector_bj_greenrate4_layer);
        },
        error: function () {
            alert('error');
        }
