...
function add_BJ_Graden_layer() {
    ...
    map1.addLayer(vector_BJ_Graden_layer);
    map2.addLayer(vector_BJ_Graden_layer);
}
...
function add_wms_BJ_Graden_layer() {
    ...
    map1.addLayer(wms_BJ_Graden_layer);
    map2.addLayer(wms_BJ_Graden_layer);
...
function add_BJ_Graden_500mbuffer_layer() {
    ...
    map1.addLayer(vector_BJ_Graden_500mbuffer_layer);
    map2.addLayer(vector_BJ_Graden_500mbuffer_layer);
}
