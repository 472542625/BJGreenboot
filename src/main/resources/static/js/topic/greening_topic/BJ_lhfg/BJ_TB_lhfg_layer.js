var image_BJ_TB_lhfg_layer = init_image_layer("BJ_TB_lhfg");
 

var vector_BJ_TB_lhfg_layer;
function add_vector_BJ_TB_lhfg_layer() {
	...
	$.ajax({
		...
		success : function(result) {
			...
			vector_BJ_TB_lhfg_layer = new ol.layer.Vector({
				source : source,
				zIndex : 1002
			});
			 map.addLayer(vector_BJ_TB_lhfg_layer);
		},
		error : function() {
			alert('error');
		}
...
function add_BJ_TB_lhfg_layer() {
	 ...
	 map.addLayer(image_BJ_TB_lhfg_layer);add_vector_BJ_TB_lhfg_layer()
	
 
}

function delete_BJ_TB_lhfg_layer() {
    delete_layer(image_BJ_TB_lhfg_layer);
	delete_layer(vector_BJ_TB_lhfg_layer);
}