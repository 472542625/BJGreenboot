...
var vector_BJ_lhfg_layer_clusters;
...
//
            ...
            var styleCache = {};
            vector_BJ_lhfg_layer_clusters =  new ol.layer.Vector({
            ...
            map.addLayer(vector_BJ_lhfg_layer_clusters);
...
function delete_BJ_lhfg_layer() {
    ...
    delete_layer(vector_BJ_lhfg_layer_clusters);
}