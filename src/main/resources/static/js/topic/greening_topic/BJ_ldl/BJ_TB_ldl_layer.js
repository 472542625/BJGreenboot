var image_BJ_TB_ldl_layer = init_image_layer("BJ_TB_ldl");
 

var vector_BJ_TB_ldl_layer;
function add_vector_BJ_TB_ldl_layer() {
...
function add_BJ_TB_ldl_layer() {
	 ...
	 map.addLayer(image_BJ_TB_ldl_layer);
	 add_vector_BJ_TB_ldl_layer() 
 
}

function delete_BJ_TB_ldl_layer() {
    delete_layer(image_BJ_TB_ldl_layer);
	delete_layer(vector_BJ_TB_ldl_layer);
}