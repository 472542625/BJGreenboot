...
var image_BJ_JD_ldl_layer_1 = init_image_layer_CQL("BJ_JD_ldl",'lvdiR<0.07');
var image_BJ_JD_ldl_layer_2 = init_image_layer_CQL("BJ_JD_ldl",'lvdiR>=0.07 and lvdiR<0.2');
var image_BJ_JD_ldl_layer_3 = init_image_layer_CQL("BJ_JD_ldl",'lvdiR>=0.2 and lvdiR<0.4');
var image_BJ_JD_ldl_layer_4 = init_image_layer_CQL("BJ_JD_ldl",'lvdiR>=0.4 and lvdiR<0.7');
var image_BJ_JD_ldl_layer_5 = init_image_layer_CQL("BJ_JD_ldl",'lvdiR>=0.7');


var vector_BJ_JD_ldl_layer_clusters_1;
var vector_BJ_JD_ldl_layer_clusters_2;
var vector_BJ_JD_ldl_layer_clusters_3;
var vector_BJ_JD_ldl_layer_clusters_4;
var vector_BJ_JD_ldl_layer_clusters_5;
function add_vector_BJ_JD_ldl_layer_1(ldl1,ldl2) {
	...
	$.ajax({
		// url: "data/" + dataurl,
		url :  '/selectByExample_bj_jd_ldl/'+ldl1+'/'+ldl2,
		type : "GET",
...
//
           ...
           /******聚类分析*******/
            ...
            var styleCache = {};
             ...
             map.addLayer(vector_BJ_JD_ldl_layer_clusters_1);
...
function add_vector_BJ_JD_ldl_layer_2(ldl1,ldl2) {
...
//
            ...
            var styleCache = {};
            vector_BJ_JD_ldl_layer_clusters_2 =  new ol.layer.Vector({
                source: clusterSource,
                style: function(feature) {
                    var size = feature.get('features').length;
            ...
            // map.addLayer(vector_BJ_JD_ldl_layer);
            map.addLayer(vector_BJ_JD_ldl_layer_clusters_2);
            clusterSource.setDistance(parseInt(100, 10));
        },
        error : function() {
            alert('error');
...
function add_vector_BJ_JD_ldl_layer_3(ldl1,ldl2) {
...
//
            ...
            var styleCache = {};
            vector_BJ_JD_ldl_layer_clusters_3 =  new ol.layer.Vector({
                source: clusterSource,
                style: function(feature) {
                    var size = feature.get('features').length;
            ...
            // map.addLayer(vector_BJ_JD_ldl_layer);
            map.addLayer(vector_BJ_JD_ldl_layer_clusters_3);
            clusterSource.setDistance(parseInt(100, 10));
        },
        error : function() {
            alert('error');
...
function add_vector_BJ_JD_ldl_layer_4(ldl1,ldl2) {
...
//
            ...
            var styleCache = {};
            vector_BJ_JD_ldl_layer_clusters_4 =  new ol.layer.Vector({
                source: clusterSource,
                style: function(feature) {
                    var size = feature.get('features').length;
            ...
            // map.addLayer(vector_BJ_JD_ldl_layer);
            map.addLayer(vector_BJ_JD_ldl_layer_clusters_4);
            clusterSource.setDistance(parseInt(100, 10));
        },
        error : function() {
            alert('error');
...
function add_vector_BJ_JD_ldl_layer_5(ldl1,ldl2) {
...
//
            ...
            var styleCache = {};
            vector_BJ_JD_ldl_layer_clusters_5 =  new ol.layer.Vector({
                source: clusterSource,
                style: function(feature) {
                    var size = feature.get('features').length;
            ...
            // map.addLayer(vector_BJ_JD_ldl_layer);
            map.addLayer(vector_BJ_JD_ldl_layer_clusters_5);
            clusterSource.setDistance(parseInt(100, 10));
        },
        error : function() {
            alert('error');
